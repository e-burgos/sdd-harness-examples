...
[ ] 2. sdd/api.json → endpoint definido por el Arquitecto (o en la sección de decisiones de plan.md en flow lite)
...
`effort`, `agent: "implementor-back"` y `recorded_at`, escrito al cerrar CADA task — nunca
